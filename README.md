...
.keyboard_ico{width:21px;height:21px;background: url(../images/login-sprite.png) no-repeat -21px 2px;;cursor:pointer;display:block;position:absolute;z-index:200;top: 9px;right: 12px;}
